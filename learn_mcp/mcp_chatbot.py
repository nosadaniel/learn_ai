...
class MCP_ChatBot:
    ...
    async def connect_to_server(self, server_name: str, server_conf: ServerConfig):
         """Connect to a single MCP server."""
         try:
            server_params = StdioServerParameters(**server_conf)
            ...
            # List available tools from this session
    ...
    async def connect_to_servers(self):
        ...
        try:
            ...
            servers: dict[str, ServerConfig] = data.get('mcpServers', {})

            # Connect to each server
            for server_name, server_conf in servers.items():
                await self.connect_to_server(server_name, server_conf)
        except Exception as e:
